    ...
    return (
      <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4">
        <div className="text-center max-w-md">
          ...
          <Button onClick={() => setLocation("/sign-in")} className="rounded-full px-8">
            Go to Sign In
          </Button>
        </div>
      </div>
    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Start your SSC preparation journey</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" type="text" placeholder="Rahul Sharma" required className="pl-10 h-12"
